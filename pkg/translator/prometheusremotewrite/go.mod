module github.com/GlancingMind/opentelemetry-collector-contrib/pkg/translator/prometheusremotewrite
...
replace github.com/GlancingMind/opentelemetry-collector-contrib/pkg/translator/prometheus => ../prometheus
