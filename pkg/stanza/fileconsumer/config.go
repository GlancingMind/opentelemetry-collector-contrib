...
package fileconsumer // import "github.com/GlancingMind/opentelemetry-collector-contrib/pkg/stanza/fileconsumer"
...
import (
	...
	"github.com/GlancingMind/opentelemetry-collector-contrib/pkg/stanza/fileconsumer/internal/metadata"
...
var allowFileDeletion = featuregate.GlobalRegistry().MustRegister(
	...
	featuregate.WithRegisterReferenceURL("https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/16314"),
)
...
var AllowHeaderMetadataParsing = featuregate.GlobalRegistry().MustRegister(
	...
	featuregate.WithRegisterReferenceURL("https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/18198"),
)
