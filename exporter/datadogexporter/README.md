...
> Please review the Collector's [security documentation](https://github.com/GlancingMind/opentelemetry-collector/blob/main/docs/security-best-practices.md), which contains recommendations on securing sensitive information such as the API key required by this exporter.

> The Datadog Exporter now skips APM stats computation by default. It is recommended to only use the [Datadog Connector](https://github.com/GlancingMind/opentelemetry-collector-contrib/tree/main/connector/datadogconnector) in order to compute APM stats.
...
This error indicates the payload size sent by the Datadog exporter exceeds the size limit (see previous examples https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/16834, https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/17566).
