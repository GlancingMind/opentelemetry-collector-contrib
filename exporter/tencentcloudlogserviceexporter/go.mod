module github.com/GlancingMind/opentelemetry-collector-contrib/exporter/tencentcloudlogserviceexporter
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.1028
