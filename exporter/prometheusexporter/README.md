...
- `endpoint` (no default): the address on which metrics will be exposed, using path `/metrics`. For full list of `ServerConfig` refer [here](https://github.com/GlancingMind/opentelemetry-collector/tree/main/config/confighttp).
