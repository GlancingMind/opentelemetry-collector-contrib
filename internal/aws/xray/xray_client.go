...
package awsxray // import "github.com/GlancingMind/opentelemetry-collector-contrib/internal/aws/xray"
...
func getModVersion() string {
	...
	for _, mod := range info.Deps {
		if mod.Path == "github.com/GlancingMind/opentelemetry-collector-contrib/exporter/awsxrayexporter" {
			return mod.Version
		}
	}
