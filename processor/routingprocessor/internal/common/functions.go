...
package common // import "github.com/GlancingMind/opentelemetry-collector-contrib/processor/routingprocessor/internal/common"
...
func Functions[K any]() map[string]ottl.Factory[K] {
	return ottl.CreateFactoryMap(
		...
		////github.com/GlancingMind/opentelemetry-collector-contrib/issues/13545
