module github.com/GlancingMind/opentelemetry-collector-contrib/processor/geoipprocessor
...
require go.opentelemetry.io/collector/pdata/pprofile v0.112.0 // indirect
