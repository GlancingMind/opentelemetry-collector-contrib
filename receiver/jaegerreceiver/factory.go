...
package jaegerreceiver // import "github.com/GlancingMind/opentelemetry-collector-contrib/receiver/jaegerreceiver"
...
import (
	...
	"github.com/GlancingMind/opentelemetry-collector-contrib/receiver/jaegerreceiver/internal/metadata"
)
...
func logDeprecation(logger *zap.Logger) {
	once.Do(func() {
		logger.Warn("jaeger receiver will deprecate Thrift-gen and replace it with Proto-gen to be compatbible to jaeger 1.42.0 and higher. See https://github.com/GlancingMind/opentelemetry-collector-contrib/pull/18485 for more details.")
