module github.com/GlancingMind/opentelemetry-collector-contrib/receiver/kubeletstatsreceiver
...
require (
	...
	github.com/GlancingMind/opentelemetry-collector-contrib/internal/k8stest v0.112.0
