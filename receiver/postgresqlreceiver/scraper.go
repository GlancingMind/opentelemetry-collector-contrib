...
package postgresqlreceiver // import "github.com/GlancingMind/opentelemetry-collector-contrib/receiver/postgresqlreceiver"
...
import (
	...
	"github.com/GlancingMind/opentelemetry-collector-contrib/receiver/postgresqlreceiver/internal/metadata"
)

const (
	readmeURL            = "https://github.com/GlancingMind/opentelemetry-collector-contrib/blob/v0.88.0/receiver/postgresqlreceiver/README.md"
...
var (
	separateSchemaAttrGate = featuregate.GlobalRegistry().MustRegister(
		...
		featuregate.WithRegisterReferenceURL("https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/29559"),
	)
)
