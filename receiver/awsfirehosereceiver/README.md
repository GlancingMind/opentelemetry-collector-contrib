...
receivers:
  awsfirehose:
    ...
    tls:
      ...
      key_file: server.key
```
The configuration includes the Opentelemetry collector's server [confighttp](https://github.com/GlancingMind/opentelemetry-collector/tree/main/config/confighttp#server-configuration),
...
### tls:
See [documentation](https://github.com/GlancingMind/opentelemetry-collector/blob/main/config/configtls/README.md#server-configuration) for more details.
