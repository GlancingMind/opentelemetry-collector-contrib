module github.com/GlancingMind/opentelemetry-collector-contrib/receiver/mysqlreceiver
...
require go.opentelemetry.io/collector/consumer/consumererror v0.112.0 // indirect
