...
import (
	...
	"github.com/GlancingMind/opentelemetry-collector-contrib/receiver/zookeeperreceiver/internal/metadata"
)
...
func TestZookeeperMetricsScraperScrape(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("skipping flaky test on windows, see https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/10171")
	}
