...
The JMX Receiver will work in conjunction with the [OpenTelemetry JMX Metric Gatherer](https://github.com/GlancingMind/opentelemetry-java-contrib/blob/main/jmx-metrics/README.md)
...
In order to use you will need to download the most [recent release](https://github.com/GlancingMind/opentelemetry-java-contrib/releases)
...
which can be downloaded from [github](https://github.com/GlancingMind/opentelemetry-java-contrib/releases). 
...
```bash
go build -ldflags "-X github.com/GlancingMind/opentelemetry-collector-contrib/receiver/jmxreceiver.MetricsGathererHash=<sha256hash>" ...
```
...
```bash
go build -ldflags "-X github.com/GlancingMind/opentelemetry-collector-contrib/receiver/jmxreceiver.MetricsGathererHash=<sha256hash>
       -X github.com/GlancingMind/opentelemetry-collector-contrib/receiver/jmxreceiver.AdditionalTargetSystems=newtarget,othernewtarget" ...
```
