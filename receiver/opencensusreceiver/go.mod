module github.com/GlancingMind/opentelemetry-collector-contrib/receiver/opencensusreceiver
...
require (
	...
	github.com/GlancingMind/opentelemetry-collector-contrib/pkg/translator/opencensus v0.112.0
