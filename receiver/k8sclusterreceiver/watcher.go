...
package k8sclusterreceiver // import "github.com/GlancingMind/opentelemetry-collector-contrib/receiver/k8sclusterreceiver"
...
import (
	...
	"github.com/GlancingMind/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata"
	...
	"github.com/GlancingMind/opentelemetry-collector-contrib/receiver/k8sclusterreceiver/internal/utils"
)
	...
	if rw.entityLogConsumer != nil {
		...
		if logs.LogRecordCount() != 0 {
			...
			if err != nil {
				...
				// https://github.com/GlancingMind/opentelemetry-collector-contrib/issues/24413
			}
		}
	}
}
