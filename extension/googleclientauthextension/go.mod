module github.com/GlancingMind/opentelemetry-collector-contrib/extension/googleclientauthextension
...
require (
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/extension/googleclientauthextension v0.48.3
