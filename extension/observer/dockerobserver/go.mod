module github.com/GlancingMind/opentelemetry-collector-contrib/extension/observer/dockerobserver
...
require (
	...
	github.com/GlancingMind/opentelemetry-collector-contrib/internal/docker v0.112.0
