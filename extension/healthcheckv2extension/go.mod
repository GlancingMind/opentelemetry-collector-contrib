module github.com/GlancingMind/opentelemetry-collector-contrib/extension/healthcheckv2extension

go 1.22.0

require (
	github.com/GlancingMind/opentelemetry-collector-contrib/internal/common v0.112.0
	github.com/GlancingMind/opentelemetry-collector-contrib/pkg/status v0.112.0
...
replace github.com/GlancingMind/opentelemetry-collector-contrib/pkg/status => ../../pkg/status
